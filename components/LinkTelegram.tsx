    ...
    <section id="link-telegram" className="rounded-2xl border-2 border-primary/20 dark:border-primary/30 bg-primary/5 dark:bg-primary/10 p-4 shadow-card sm:p-6">
      ...
      {!code ? (
        ...
        <div className="rounded-xl border border-border dark:border-slate-600 bg-slate-50 dark:bg-slate-800 p-4">
          ...
          <p className="mb-3 text-xs text-muted dark:text-slate-500">Kode berlaku 10 menit. Setelah kirim, akun Telegram akan terhubung.</p>
          <div className="flex flex-wrap items-center gap-3">
            <a
              href={TELEGRAM_BOT_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-sm font-medium text-white transition hover:bg-primary-hover dark:bg-sky-600 dark:hover:bg-sky-500"
            >
